...
export const BottomLine = () => {
  return (
    <>
      ...
      <PlusSvg className="hidden absolute top-[54.9375rem] left-[2.1875rem] z-10 pointer-events-none xl:block" />
...
const Rings = () => {
  return (
    <>
      <div className="absolute top-1/2 left-1/2 w-[65.875rem] aspect-square border border-n-2/10 roudned-full -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute top-1/2 left-1/2 w-[51.375rem] aspect-square border border-n-2/10 roudned-full -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute top-1/2 left-1/2 w-[36.125rem] aspect-square border border-n-2/10 roudned-full -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute top-1/2 left-1/2 w-[23.125rem] aspect-square border border-n-2/10 roudned-full -translate-x-1/2 -translate-y-1/2" />
    </>
  );
};
